# Archived plug implementation history — 18–19 September 2026

> **HISTORICAL / SUPERSEDED.** This is the original chronological implementation
> record through source `0ed1b6e10ac1a7692f6114cc8647306ce2a43d9d`. Statements
> about remaining work, counts, deployment and rollback apply to their dated phase.
> Use the [current operational guide](plug-app.md), [final closure report](2026-09-19-patient-access-ownership.md)
> and [current inventory](2026-09-19-ownership-closure-hunks.md) for current decisions.
> Historical commands below are evidence, not a current deployment runbook.
