...
# Suriname extension, see care/security/authorization/PATIENT_DEPARTMENT_ACCESS.md
PATIENT_DEPARTMENT_LONGITUDINAL_ACCESS_ENABLED = env.bool(
    "PATIENT_DEPARTMENT_LONGITUDINAL_ACCESS_ENABLED", default=True
)
