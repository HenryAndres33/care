...
from care_suriname.reports.clinical_narrative import (
    normalize_diagnosis_history_layout,
)
from care_suriname.reports.correspondence_template_body import (
...
def compile_correspondence_html(
    *,
    ...
    clinical_attachment = "" if template_contains_clinical_note else clinical_note
